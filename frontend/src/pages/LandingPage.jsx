    ...
    <div className="min-h-screen bg-surface-900 bg-grid-pattern flex flex-col">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-4 border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          <span className="font-display text-lg font-bold text-white tracking-tight">CodeMind AI</span>
        </div>
        <div className="flex items-center gap-3">
      ...
      {/* Hero */}
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-20 text-center animate-fade-in">
        <div className="max-w-2xl w-full">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-900/60 border border-brand-700/40 text-brand-300 text-xs font-medium mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-4">
            ...
            <button
              ...
              disabled={loading}
              className="btn-primary whitespace-nowrap glow-brand sm:w-auto w-full justify-center"
            >
              {loading ? (
                <>
          ...
          {/* Example repos */}
          <div className="mt-12">
            <p className="text-white/25 text-xs uppercase tracking-widest mb-5 font-medium">Try an Example</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {EXAMPLE_REPOS.map(repo => (
                <button
                  ...
                  disabled={loading}
                  className="glass-panel p-4 text-left hover:border-brand-700/40 hover:bg-surface-700/60 transition-all duration-200 group disabled:opacity-50"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-white/40 text-xs mt-0.5 leading-snug">{repo.desc}</p>
                    </div>
                  </div>
                </button>
              ))}
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-white/5 px-8 py-4 flex items-center justify-between text-white/25 text-xs">
        <span>© 2024 CodeMind AI. Powering the next generation of developers.</span>
